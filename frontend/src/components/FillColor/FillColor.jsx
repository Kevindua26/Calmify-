...
const FillColor = () => {
  ...
  useEffect(() => {
    ...
    setInitialX(container.clientWidth / svgWidth);
    setInitialY(container.clientHeight / svgHeight);
  }, []);

  const handleContainerClick = (e) => {
    const container = containerRef.current;
    let mouseX = deviceType === "mouse" ? e.clientX : e.touches[0].clientX;
    let mouseY = deviceType === "mouse" ? e.clientY : e.touches[0].clientY;
    ...
    console.log(`Circle: cx=${finalX}, cy=${finalY}, color=${currentColor}, r=${currentSize}`);

    setCircles([...circles, { cx: finalX, cy: finalY, color: currentColor, r: currentSize }]);
  };
  ...
  return (
    <div className="FillColor">
      ...
      <div
        ...
        onClick={deviceType === "mouse" ? handleContainerClick : undefined}
        onTouchStart={deviceType === "touch" ? handleContainerClick : undefined}
      >
